...
import com.ehospital.billdesk.billdeskdemo.service.TransactionService;
...
public class TransactionController {
    ...
    public ResponseEntity<TransactionRequest> createTransaction(@PathVariable ("orderId") String orderId) {
        try {
            ...
            TransactionRequest createdTransactionRequest = transactionService.createTestTransaction();
            createdTransactionRequest.setOrderId(orderId);
            ObjectMapper mapper = new ObjectMapper();
            payload = mapper.convertValue(createdTransactionRequest, Map.class);
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                ...
                return new ResponseEntity<>(createdTransactionRequest, HttpStatus.CREATED);
            } else {
